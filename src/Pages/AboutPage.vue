<template>
    ...
    <div class="page-content">
        <h1>About Us</h1>
        <p>Welcome to our website! We are dedicated to providing valuable content on various topics. In this portal you can learn about various topics.</p>
        <p>Learning is the key to success.</p>
    </div>
